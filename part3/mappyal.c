...
//long int * myanblkpt;
	...
	i = mapnumblockstr; while (i) {
		...
		if (myblkstrpt->fgoff!=0)
			(myblkstrpt->fgoff) =(BITMAP *) abmTiles[myblkstrpt->fgoff];
		if (myblkstrpt->fgoff2!=0)
			(myblkstrpt->fgoff2) = (BITMAP *)abmTiles[myblkstrpt->fgoff2];
		if (myblkstrpt->fgoff3!=0)
			(myblkstrpt->fgoff3) = (BITMAP *)abmTiles[myblkstrpt->fgoff3];
		myblkstrpt++; i--;
	}
